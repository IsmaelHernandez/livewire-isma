                ...
                <div class="col-span-6 sm:col-span-4 relative">
                    ...
                    @else
                        <div class="h-32 bg-gray-50 border-2 border-dashed rounded flex items-center justify-center">
                            <x-jet-label for="image" class="cursor-pointer inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition" :value="__('Select Image')"/>
                        </div>
                    @endif
                    <x-jet-input wire:model="image" id="image" class="hidden mt-1 block w-full" type="file" />
                    <x-jet-input-error for="image" class="mt-3" />
                </div>
